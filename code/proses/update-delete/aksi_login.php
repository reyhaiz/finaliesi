<body>
    ...
    if ($aksi == "delete") {
        ...
        if ($delete_login_query) {
            header("location:halaman_utama.php?tabel_login=$table_login");
        } else {
    ...
    <form action="code/proses/update-delete/update/update_login.php" method="POST">
        ...
        <table id="tabel-pendaftaran">
            ...
            <tr>
                <td><input type="text" name='username' size="25px" maxlength="6" style="background-color:#E0DFDF"
            ...
            <tr>
                <td><input type="text" name="password" size="25px" maxlength="35" placeholder="ketikkan nama jurusan."
                        value="<?php echo $isi['password']; ?>" required></td>
            </tr>
