<body>
    ...
    if ($aksi == "delete") {
        ...
        if ($delete_jurusan_query) {
            header("location:halaman_utama.php?tabel_jurusan=$table_jurusan");
        } else {
    ...
    <form action="code/proses/update-delete/update/update_jurusan.php" method="POST">
        ...
        <table id="tabel-pendaftaran">
            ...
            <tr>
                <td><input type="text" name='kode_jurusan' size="25px" maxlength="6" style="background-color:#E0DFDF"
                        value="<?php echo $kode_jurusan; ?>" readonly></td>
            </tr>
            ...
            <tr>
                <td><input type="text" name="nama_jurusan" size="25px" maxlength="35"
                        placeholder="ketikkan nama jurusan." value="<?php echo $isi['nama_jurusan']; ?>"
                        required>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Update"></td>
            </tr>
            <?php } ?>
        </table>
        <?php
