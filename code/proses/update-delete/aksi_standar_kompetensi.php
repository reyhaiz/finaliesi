<body>
    ...
    <form action="code/proses/update-delete/update/update_standar_kompetensi.php" method="POST">
        ...
        <table id="tabel-pendaftaran">
            ...
            <tr>
                <td><input type="text" name='kode_sk' size="25px" maxlength="6" style="background-color:#E0DFDF"
                        value="<?php echo $kode_sk; ?>" readonly></td>
            </tr>
            ...
            <tr>
                <td><input type="text" name="kode_mp" size="25px" maxlength="50" style="background-color:#E0DFDF"
            ...
            <tr>
                <td><input type="text" name='nama_sk' size="25px" maxlength="50" value="<?php echo $isi['nama_sk']; ?>"
                        required></td>
            </tr>
