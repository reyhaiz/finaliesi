...
<head>
    <meta charset="utf-8">
    <title>SMPN 1 Kedawung</title>
    <link rel="stylesheet" type="text/css" href="css/style.css" />
    <link href='logo/MTs.png' rel='SHORTCUT ICON' />
</head>
    ...
    <div id="luar">
        <div id="welcome">
            ...
            <?php
                ...
                onClick="return confirm('Apakah anda yakin untuk logout, <?php echo $_SESSION['nama_guru']; ?>?')">Logout</a>
            <?php } else if ($_SESSION['type_user'] == "Siswa") { ?>
            <b><?php echo $_SESSION['nama_siswa']; ?></b> <a href="logout.php"
                onClick="return confirm('Apakah anda yakin untuk logout, <?php echo $_SESSION['nama_siswa']; ?>?')">Logout</a>
            <?php } else { ?>
            <b><?php echo $_SESSION['username']; ?></b> <a href="logout.php"
                onClick="return confirm('Apakah anda yakin untuk logout, <?php echo $_SESSION['username']; ?>?')">Logout</a>
            <?php } ?>
            ...
            <nav>
                <ul>
                    <?php
						...
						?>
                    <a href="halaman_utama.php?tabel_nilai=">
                        <li>NILAI</li>
                    </a>
                    <?php } else if ($_SESSION['type_user'] == "Siswa") {
						?>
                    <a href="halaman_utama.php?informasi_nilai=">
                        <li>NILAI</li>
                    </a>
                    <?php } ?>
                    <?php
						if ($_SESSION['type_user'] != "Siswa") {
						?>
                    <a href="halaman_utama.php?tabel_wali_murid=">
                        <li>WALI MURID</li>
                    </a>
                    <?php } else if ($_SESSION['type_user'] == "Siswa") {
						?>
                    <a href="halaman_utama.php?informasi_walimurid=">
                        <li>WALI MURID</li>
                    </a>
                    <?php } ?>
                    <?php
						if ($_SESSION['type_user'] != "Siswa") {
						?>
                    <a href="halaman_utama.php?tabel_siswa=">
                        <li>SISWA</li>
                    </a>
                    <?php } else if ($_SESSION['type_user'] == "Siswa") {
						?>
                    <a href="halaman_utama.php?informasi_siswa=">
                        <li>SISWA</li>
                    </a>
                    <?php } ?>
                    <?php if ($_SESSION['type_user'] == "Admin") { ?>
                    <a href="halaman_utama.php?tabel_guru=">
                        <li>GURU</li>
                    </a>
                    <?php } else if ($_SESSION['type_user'] == "Guru") { ?>
                    <a href="halaman_utama.php?informasi_guru=">
                        <li>GURU</li>
                    </a>
                    <?php } ?>
                    <?php
						if ($_SESSION['type_user'] == "Admin") { ?>
                    <a href="halaman_utama.php?tabel_standar_kompetensi=">
                        <li>STANDAR KOMPETENSI</li>
                    </a>
                    <?php } else if ($_SESSION['type_user'] == "Guru") { ?>
                    <a
                        href="halaman_utama.php?tabel_standar_kompetensi_untuk_guru=">
                        <li>STANDAR KOMPETENSI</li>
                    </a>
                    <?php } ?>
                    <?php if ($_SESSION['type_user'] != "Siswa") { ?>
                    <a href="halaman_utama.php?tabel_jurusan=">
                        <li>KELAS</li>
                    </a>
                    <?php } ?>
                    <a href="halaman_utama.php?tabel_mapel=">
                        <li>MATA PELAJARAN</li>
                    </a>
                    <?php
						if ($_SESSION['type_user'] == "Admin") {
						?>
                    <a href="halaman_utama.php?tabel_login=">
                        <li>ACCOUNT</li>
                    </a>
                    <?php } ?>
                    <a href="halaman_utama.php?home=">
                        <li>HOME</li>
                    </a>
